...
export const EventCard = React.memo(function EventCard({ ev, onOpen, wishlisted, onWishlist, wishlistCount, registered }: any) {
  const isScheduled = ev.registrationStatus === 'SCHEDULED' || ev.registration_status === 'SCHEDULED';
  const isClosed = ev.registrationStatus === 'CLOSED' || ev.registration_status === 'CLOSED';
...
/* ---------------- Featured (hero) ---------------- */
export const FeatureCard = React.memo(function FeatureCard({ ev, onOpen, wishlisted, onWishlist, wishlistCount }: any) {
  const isScheduled = ev.registrationStatus === 'SCHEDULED' || ev.registration_status === 'SCHEDULED';
  const isClosed = ev.registrationStatus === 'CLOSED' || ev.registration_status === 'CLOSED';
