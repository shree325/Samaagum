          ...
          <div style={{ flex: 1, minWidth: 0 }}>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 12, flexWrap: "wrap", marginBottom: 16 }}>
              <div style={{ display: "flex", alignItems: "center", gap: 2 }}>
                <button onClick={() => onVoteThread(activeThread.id, atUserVote === 1 ? 0 : 1)} style={{ background: "none", border: "none", cursor: "pointer", fontWeight: 800, color: atUserVote === 1 ? "var(--accent-2)" : "var(--ink-3)", padding: "4px 6px", fontSize: 14 }}>▲</button>
                <span style={{ fontWeight: 600, color: "var(--ink-2)", minWidth: 16, textAlign: "center" }}>{atVoteScore}</span>
                <button onClick={() => onVoteThread(activeThread.id, atUserVote === -1 ? 0 : -1)} style={{ background: "none", border: "none", cursor: "pointer", fontWeight: 800, color: atUserVote === -1 ? "#e74c3c" : "var(--ink-3)", padding: "4px 6px", fontSize: 14 }}>▼</button>
              </div>
              ...
              <div style={{ marginTop: 20, display: "flex", gap: 12 }}>
                ...
                <div style={{ flex: 1, display: "flex", flexDirection: "column", gap: 8 }}>
                  ...
                  <div style={{ display: "flex", justifyContent: "flex-end" }}>
                    <button className="hbtn hbtn--primary hbtn--sm" disabled={!replyDraft.trim() || submittingReply} onClick={onSubmitReply}>
