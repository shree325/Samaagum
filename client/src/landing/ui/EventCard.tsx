  ...
  return (
    ...
    >
      ...
      <div className="event-body">
        ...
        <h4>{event.title}</h4>
        <div className="org" style={{ fontSize: 11, color: "var(--ink-2)", marginBottom: 4 }}>
          Host: <strong>{event.host}</strong>
        </div>
        {event.isOnline && event.speaker && (
          <div className="speaker" style={{ fontSize: 10.5, color: "var(--ink-3)", marginBottom: 4 }}>
            🎙️ {event.speaker} {event.duration && `· ${event.duration}`}
          </div>
        )}
        <div className="loc" style={{ fontSize: 11, color: "var(--ink-3)", display: "flex", alignItems: "center", gap: 6, marginBottom: 8 }}>
        ...
        <div className="event-foot" style={{ marginTop: "auto", display: "flex", justifyContent: "space-between", alignItems: "center", borderTop: "1px solid var(--card-border)", paddingTop: 8 }}>
          ...
          <button
            ...
            style={{ background: "var(--primary)", borderColor: "transparent", color: "#fff", padding: "4px 10px", fontSize: 10.5 }}
          >
            View Event
          </button>
        </div>
